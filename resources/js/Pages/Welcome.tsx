    ...
    return (
        <div className="relative min-h-screen lg:h-screen flex flex-col justify-between overflow-x-hidden lg:overflow-hidden bg-white select-none">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
                ...
                <div className="absolute top-0 right-0 w-full lg:w-[40%] h-[480px] sm:h-80 lg:h-screen bg-[#0266E0] z-0">
                    {/* Imagen de la chica */}
                    <div className="absolute inset-0 z-0">
                        <img
                            src="/assets/hero-img.png"
                            alt="Welcome Visual"
                            className="w-full h-full object-contain lg:object-cover object-bottom lg:scale-95 origin-bottom opacity-100 brightness-105 transition-all duration-500"
                        />
                    ...
                    <div className="absolute bottom-0 left-0 w-full h-16 lg:top-0 lg:left-0 lg:h-full lg:w-24 z-10">
                    ...
                    <div className="absolute bottom-10 right-8 lg:bottom-6 lg:right-12 z-20 opacity-40">
                        <img src="/assets/logo-ph-blanco.png" alt="Logo PH" className="h-8 lg:h-12 w-auto brightness-200" />
                    </div>
                </div>
            </div>
            ...
            <div className="flex-1 flex items-stretch relative z-10 overflow-hidden pt-[400px] lg:pt-6">
                <Hero />
            </div>
            ...
            <footer className="w-full relative z-20">
                <div className="max-w-7xl mx-auto px-6 md:px-12">
                    <div className="w-full lg:w-[60%] py-6 flex flex-col sm:flex-row items-center justify-between text-[10px] text-slate-400 gap-4">
                        <span className="font-bold opacity-60">© 2026 PREPAHID. Todos los derechos reservados.</span>
                        <div className="flex flex-col gap-1 sm:flex-row sm:items-center sm:gap-4 font-bold uppercase tracking-widest">
