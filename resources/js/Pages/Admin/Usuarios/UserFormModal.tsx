                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-4">
                                <p className="text-xs text-blue-100 leading-relaxed font-normal">
                                    {mode === 'create' 
                                        ? 'Genera una cuenta de acceso para un docente o administrador. Configura su correo e ingresa una contraseña temporal segura.'
                                        : 'Modifica los permisos o inhabilita el acceso temporal de este usuario.'}
                                </p>
                            </div>
                        </div>
