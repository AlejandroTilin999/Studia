                        ...
                        <div className="space-y-4">
                            <p className="text-[11px] md:text-xs text-blue-100 leading-relaxed font-normal">
                                {mode === 'create'
                                    ...
                                    : 'Modifica los datos personales, matrícula, contacto y asignación de grupo del alumno.'}
                            </p>
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-left">
                            <div className="space-y-1.5">
                                ...
                                <FormInput
                                    ...
                                    placeholder="Ej: RCM442026"
                                    className="bg-white border border-slate-200 text-slate-800 font-mono h-9 text-xs uppercase"
                                    icon={<Hash size={13} />}
                                />
                                {errors.matricula && <span className="text-red-500 text-[10px] mt-1 block">{errors.matricula}</span>}
                            </div>
                            <div className="space-y-1.5">
