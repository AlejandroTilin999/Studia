    ...
    return (
        ...
        >
            ...
            <div className="p-5 bg-slate-50 border border-slate-100 rounded-2xl text-[11px] text-left">
                ...
                <span className="text-[10.5px] text-blue-655 bg-blue-50 px-2 py-0.5 rounded font-bold border border-blue-100 inline-block mt-2">
                    {teacher.specialty}
                </span>
            </div>
            ...
            <div className="space-y-4 text-left mt-5">
                ...
                {teacher.assignments.length > 0 ? (
                    ...
                    <div className="text-center py-8 text-slate-400 text-xs">
                        Este profesor aún no cuenta con materias asignadas
