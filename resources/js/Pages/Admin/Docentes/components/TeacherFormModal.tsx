                ...
                <div className="col-span-1 md:col-span-3 p-5 md:p-6 flex flex-col justify-between min-h-0 md:min-h-[440px] relative bg-white rounded-b-[10px] md:rounded-r-[10px] md:rounded-bl-none">
                    ...
                    <div className="mt-8 flex justify-end items-center gap-2 border-t border-slate-100 pt-4 select-none">
                        ...
                        <button
                            type="submit"
                            disabled={processing}
                            className="px-5 py-2 bg-[#0266E0] hover:bg-blue-700 active:scale-95 active:bg-blue-800 active:translate-y-[1px] disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-xl text-xs font-bold transition-all transform duration-75 focus:outline-none cursor-pointer flex items-center gap-2"
                        >
                            {processing ? (
                                <>
