...
export default function NotificacionesIndex({ notificaciones, notifStats }: IndexProps) {
    ...
    const notifData = notificaciones?.data || [];
    const hasUnread = notifData.some((n:any) => !n.leido);
                    ...
                    notifData.length === 0 ? (
                        ...
                        notifData.map((n:any) => (
                            <div
                                key={n.id}
                                className={cn(
                                    "relative overflow-hidden p-5 rounded-lg border transition-all duration-300",
                                    n.leido
